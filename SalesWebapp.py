...
import sklearn
#loading models
model = pickle.load(open('sales_rf.pkl','rb'))
#flask app
app = Flask(__name__)
...
def predict():
    if request.method == 'POST':
        ...
        features = np.array([[Item_Indentifier,Item_weight,Item_Fat_Content,Item_visibility,Item_Type,Item_MPR,Outlet_identifier,Outlet_established_year, Outlet_location_type,Outlet_type]],dtype=np.float32)
